...
export default function LoginButton() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center max-w-sm mx-auto px-4">
            ...
            <button
                onClick={() => login()}
                className="w-full bg-primary hover:bg-p-dark text-surface py-3 px-4 rounded-md font-medium transition-colors shadow-sm flex items-center justify-center gap-3"
            >
